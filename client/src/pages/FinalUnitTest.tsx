...
const SECTIONS: Section[] = [
  {
    ...
    passage: "Many young people now use an (1) to learn about exercise and healthy habits. Inside the app, there is an (2) of photos showing correct movements and a short (3) explaining why exercise is important. To make learning easier, the exercises are organized using the (4), from A to Z. Each exercise shows the correct (5) of times you should repeat each body movement. There are instructions on to make each (6) stronger by lifting more weight. It even has stretching exercises like (7) rotations, which are important to do before a run. Some activities even ask students to walk (8) to improve balance.\nThe app also gives nutritional information. For example, it explains all the nutrients in a single green (9). Lastly, it shows (10) how many minutes students should exercise each day.\nThere's (11) too many good features in this app, and only a few bad ones. (12), this app is worth getting.",
  ...
  },
  {
    ...
    passage: "Many young people choose to (1) special training programs to prepare for service jobs. Some want to join the (2) to fight on the ground, others hope to work in the (3) to keep our skies safe, and some plan to help injured soldiers by working on an (4) team.\nDuring training, each trainee group will havea an (5) who supports each trainee and helps the leader. Trainees must stay (6) of safety rules at all times. The work is not easy, and many describe it as a long (7). They must (8) stress, pain, and tiredness without giving up.\nIn physical training, students learn to (9) rest with work and keep their (10) while blindfolded. They also learn how to (11) difficult situations calmly instead of panicking.\nAt the end of the program, the best trainees receive an (12) for their hard work. Leaders may even (13) those who show strong responsibility and teamwork. Many students learn their real (14) is in who they are, not in how they look. In the end, success is not about who you (15), but about what you can give.",
  ...
  },
  {
    ...
    passage: "At the start of the school year, students can (1) to join different clubs and programs. Each student must fill out an (2) online before the deadline.\nBefore the interview, teachers remind students that their (3) and attitude are important. When students (4) confident, they often feel more relaxed.\nThe club is open to (5)/ (13) who is interested, and students do not need special skills. We used to have a rule that you had to play a musical instrument, but not (10)! You just need to have an interest in something and (12) effort in talking about it with others. It could be (6)! Some students worry about joining (7), but they soon realize that many members are very (8).\nMeetings can take place (9) on campus, so members should always check the schedule. If students feel nervous, they are encouraged to try (11).",
  ...
  },
  {
    ...
    passage: "When Leo moved into a new (1), he felt excited but also (2) because he didn't know anyone. The (3) was large and modern, and the (4) around it was busy and noisy.\nOn his first day, he walked (5) the neighborhood to learn where things were. He found a small (6) on the corner and a park nearby. (7) from the noise, the place felt friendly.\nAt first, the sounds from other homes began to (8) him, and one night the noise was truly (9). However, there were moments that continued to (10) him. The city lights at night were (11), and he often felt (15) by how lucky he was to live here.\nInside his apartment, Leo sat in his (13) and thought about his day and how great it was to be (12) to experience all this new change. Even though he lived far (14) from his old home, he was happy to call this new place home.",
  ...
  },
  {
    ...
    passage: "Many families plan trips differently depending on the (1) of everyone. A child and an (2) grandparent may not enjoy the same schedule.\nFor many parents, it can feel like (3) have passed since the last family holiday. Some families travel to celebrate an (4) or to visit an (5) place.\nOn travel days, an (6) often rings early, sometimes before 6:00 (7). Some people are already (8), while others are still (9). Traveling is stressful for parents with young kids, and it may (10) them more quickly. \nAt the (11), families check in with the (12) and carry their (13). Inside the building, the (14) helps everyone stay comfortable while they wait. When they finally (15) at the destination, the place and culture can sometimes (16) younger family members—especially if everything feels new.",
