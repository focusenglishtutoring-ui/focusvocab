...
const QUESTIONS = [
  ...
  "6. The nurse had to __________ a clean bandage to the cut.",
  "7. We celebrate our wedding __________ every October.",
  "8. The museum is full of __________ treasures from Egypt.",
  "9. Johnny had to __________ to Jenny for pushing her during break time.",
  ...
  "15. A rainbow can __________ in the sky after a storm passes.",
  "16. They __________ to be the best team in the league.",
  ...
  "21. Jimmy said there was a UFO __________ last night.",
  ...
  "41. Sudden noises can __________ the birds in the area.",
  ...
  "46. Is it __________ if I open the window?",
  "47. Her magic tricks __________ everyone who watched her.",
  "48. The class starts at 9 __________ tomorrow morning.",
  "49. The teacher doesn't __________ students to use your phone during the test.",
...
const ANSWERS = [
  ...
  "aim (v.)", "album (n.)", "anybody (pron.)", "announce (v.)", "age (n.)",
